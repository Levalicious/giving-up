...
public class Main {
    public static void main(String[] args) throws Exception {
        /*
        System.out.println(FailHash.hash("Kill me"));
        System.out.println(fromHex(FailHash.hash("Kill me")).length);
        */
        ...
        */
        ...
        byte[] data = (new GsonBuilder().setPrettyPrinting().create().toJson(Blockchain.chain)).getBytes("UTF-8");
        Path file = Paths.get("chain.json");
