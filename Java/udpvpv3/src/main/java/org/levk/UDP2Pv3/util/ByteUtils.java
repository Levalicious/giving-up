...
public class ByteUtils {
     ...
     */
    public static byte[] longToBytes(long val, int length) {
        byte[] out = ByteBuffer.allocate(Long.BYTES).putLong(val).array();

        return Arrays.copyOfRange(out,Long.BYTES - length, Long.BYTES);
    }
