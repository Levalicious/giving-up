...
import Triethereum.net.client.ConfigCapabilities;
import Triethereum.net.eth.message.NewBlockMessage;
import Triethereum.net.eth.message.TransactionsMessage;
...
import static Triethereum.net.eth.EthVersion.*;
import static Triethereum.net.message.StaticMessages.*;
