...
public class Config {
    ...
    public static final int DEFAULT_MIN_NUMBER_OF_ACTIVE_CONNECTIONS = 16;

    public static final int DEFAULT_MAX_READ_IDLE_SECONDS = 120;

    public static final int DEFAULT_KEEP_ALIVE_SECONDS = 15;

    public static final int DEFAULT_PING_TIMEOUT_SECONDS = 12;

    public static final int DEFAULT_AUTO_DISCOVERY_PING_FREQUENCY = 10;

    public static final int DEFAULT_PING_TTL = 16;

    public static final int DEFAULT_LEADER_ELECTION_TIMEOUT_SECONDS = 12;

    public static final int DEFAULT_LEADER_REJECTION_TIMEOUT_SECONDS = 24;
