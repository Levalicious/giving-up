...
public class PoolManager implements TxPool, UTXOPool, LeafPool, Serializable {
    /*
    public static addTx(Transaction tx) {
    ...
    */
    ...
    public static void fillPool(long txNum) {
        ...
        for(long i = 0; i < txNum; i++) {
            ...
            wallet.newWallet();
            Transaction tx = new Transaction(wallet.getPubAddress(), "1348rnwexLA8ifeEaD78uhWCHVeV4FWXWTtayFD1wTMHKxGgfmYSM3rXLHUx4PRLkVBRbjC1pPo3yujzNNkzzK1q5", 10, null, wallet.getWIF());
