...
import Triethereum.config.blockchain.OlympicConfig;
import Triethereum.config.net.*;
import Triethereum.core.Genesis;
import Triethereum.core.genesis.GenesisConfig;
import Triethereum.core.genesis.GenesisJson;
import Triethereum.core.genesis.GenesisLoader;
import Triethereum.crypto.ECKey;
import Triethereum.net.p2p.P2pHandler;
import Triethereum.net.rlpx.MessageCodec;
import Triethereum.net.rlpx.Node;
import Triethereum.util.BuildInfo;
import Triethereum.util.ByteUtil;
import Triethereum.validator.BlockCustomHashRule;
            ...
            if (genesisJson.getConfig() != null && genesisJson.getConfig().isCustomConfig()) {
                ...
                if (config.hasPath("blockchain.config.name")) {
                    ...
                    try {
                        ...
                        throw new RuntimeException("The class specified via blockchain.config.class '" + className + "' is not instance of Triethereum.config.BlockchainForkConfig", e);
