...
import Triethereum.net.eth.message.EthMessage;
import Triethereum.net.eth.message.GetNodeDataMessage;
import Triethereum.net.eth.message.GetReceiptsMessage;
import Triethereum.net.eth.message.NodeDataMessage;
import Triethereum.net.eth.message.ReceiptsMessage;

import Triethereum.sync.PeerState;
import Triethereum.util.ByteArraySet;
import Triethereum.util.Value;
...
import static Triethereum.net.eth.EthVersion.V63;
