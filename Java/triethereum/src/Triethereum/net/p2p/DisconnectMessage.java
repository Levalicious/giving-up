...
import static Triethereum.net.message.ReasonCode.REQUESTED;
import static Triethereum.net.message.ReasonCode.UNKNOWN;
import static Triethereum.net.p2p.P2pMessageCodes.DISCONNECT;

/**
 * Wrapper around an Ethereum Disconnect message on the network
 *
 * @see Triethereum.net.p2p.P2pMessageCodes#DISCONNECT
 */
