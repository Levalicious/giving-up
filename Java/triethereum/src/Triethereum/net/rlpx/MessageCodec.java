...
import Triethereum.net.eth.message.EthMessageCodes;
import Triethereum.net.message.Message;
import Triethereum.net.message.MessageFactory;
import Triethereum.net.message.ReasonCode;
import Triethereum.net.p2p.P2pMessageCodes;
import Triethereum.net.server.Channel;
import Triethereum.net.shh.ShhMessageCodes;
import Triethereum.net.swarm.bzz.BzzMessageCodes;
...
import static Triethereum.net.rlpx.FrameCodec.Frame;
