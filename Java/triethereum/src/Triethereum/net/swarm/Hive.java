 ...
 */
package Triethereum.net.swarm;

import Triethereum.net.rlpx.Node;
import Triethereum.net.rlpx.discover.table.NodeEntry;
import Triethereum.net.rlpx.discover.table.NodeTable;
import Triethereum.net.swarm.bzz.BzzPeersMessage;
import Triethereum.net.swarm.bzz.BzzProtocol;
import Triethereum.net.swarm.bzz.PeerAddress;
...
//            ret.add(thisPeer.getPeer(new PeerAddress(node)));
     ...
     *  ({@link Triethereum.net.swarm.Hive.HiveTask#expireTime} and a limited number of
     *  peers to process ({@link Triethereum.net.swarm.Hive.HiveTask#maxPeers}).
