...
import Triethereum.net.p2p.PingMessage;
import Triethereum.net.p2p.PongMessage;
...
import static Triethereum.net.message.StaticMessages.DISCONNECT_MESSAGE;
