 ...
 */
package Triethereum.net.eth.handler;
...
import Triethereum.sync.PeerState;
import Triethereum.sync.SyncStatistics;
import Triethereum.util.ByteUtil;
import Triethereum.util.Utils;
import Triethereum.validator.BlockHeaderRule;
import Triethereum.validator.BlockHeaderValidator;
...
import static Triethereum.net.eth.EthVersion.V62;
import static Triethereum.net.message.ReasonCode.USELESS_PEER;
import static Triethereum.sync.PeerState.*;
import static Triethereum.sync.PeerState.BLOCK_RETRIEVING;
import static Triethereum.util.Utils.longToTimePeriod;
