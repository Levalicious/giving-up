...
public class Value {
    ...
    public byte[] asBytes() {
        ...
        return util.ByteUtil.EMPTY_BYTE_ARRAY;
    }
    ...
    public String toString() {
        ...
        if (isList()) {
            ...
            if (list.length == 2) {
                ...
                String keyString = util.ByteUtil.nibblesToPrettyString(keyNibbles);
            ...
            if (isHashCode()) {
                ...
                for (byte oneByte : asBytes()) {
                    if (oneByte < 16) {
                        output.append("\\x").append(util.ByteUtil.oneByteToHexString(oneByte));
                    } else {
