...
import org.levk.UDP2Pv3.util.datastore.FileDB;
...
import static org.levk.UDP2Pv3.util.HashUtil.blake2;
...
public class BiTrie {
    ...
    public BiTrie(String name) throws IOException {
        map = new FileDB(name + "Trie");
